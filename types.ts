...
export interface ServerEvent {
  id:string;
  type: 'AGGREGATED_EVENT' | 'LEARNING_UPDATE' | 'DIRECTIVE_PUSH' | 'KNOWLEDGE_SYNC' | 'PROACTIVE_ALERT_PUSH';
  timestamp: string;
  payload: AggregatedEvent | LearningUpdate | DirectivePush | KnowledgeSync | ProactiveAlertPush;
}
